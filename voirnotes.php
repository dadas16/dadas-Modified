<?php
	...
	if($totals>0)
	{
		...
		$sql = "SELECT a.*, e.*
         ...
         WHERE a.note !='NULL' LIMIT {$startpoint} , {$limit}";
   ...
   <thead>
	...
	while($data=mysql_fetch_assoc($resultat)){
    	...
    	<tr id=".$id.">
            ...
            ?><td><div onClick="window.open('certificat.php?id=<? echo $id;?>','','width=1200, height=680,left=100,top=(0, toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no');" ><img src="images/user_edit.png" alt="Certificat" title="Générer Certificat/ Attestation"  /></div></td><?
