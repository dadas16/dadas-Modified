...
$constructs ="SELECT * FROM ".database_table_name." WHERE demandeur LIKE '%$search_each%' OR module LIKE '%$search_each%' OR dure LIKE '%$search_each%' OR benefit LIKE '%$search_each%' OR statut LIKE '%$search_each%' OR contact LIKE '%$search_each%' ";
...
if(!$start)
$start=0; 
$requete="SELECT * FROM ". database_table_name." WHERE demandeur LIKE '%$search_each%' OR module LIKE '%$search_each%' OR dure LIKE '%$search_each%' OR benefit LIKE '%$search_each%' OR statut LIKE '%$search_each%' OR contact LIKE '%$search_each%' LIMIT $start, $per_page";
//echo $requete;exit;
